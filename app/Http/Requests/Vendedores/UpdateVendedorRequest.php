...
class UpdateVendedorRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'ci'          => ['nullable', 'string', 'max:20', Rule::unique('vendedores', 'ci')->ignore($id)->whereNull('deleted_at')],
            'telefono'    => ['nullable', 'string', 'max:30'],
            'email'       => ['nullable', 'email', 'max:255', Rule::unique('vendedores', 'email')->ignore($id)->whereNull('deleted_at')],
